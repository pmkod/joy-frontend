...
const DiscussionsLayout = ({ children }: DiscussionsLayoutProps) => {
  ...
  return (
    <div className='flex h-screen '>
      ...
      {/* Left part */}
      <div className="w-80 md:w-full flex flex-col border-r border-two">
        ...
        <div className="px-4 py-3 border-b">
          ...
          <Input type="text" hasMarginBottom={false} placeholder="Rechercher" />
        </div>
        <div className="flex-1 overflow-y-auto">
          ...
          {discussions.map(() => (
            ...
            <Link href={`/discussions/1000000`}>
              <div
                className={`px-4 py-3 ${false ? "bg-gray-100" : "hover:bg-gray-200"
