  ...
  return (
    <div>
      <div className="flex flex-wrap gap-5">
        ...
        {/*  */}
        <Button size="xs" colorScheme="danger">Terminer</Button>
        <Button size="sm" colorScheme="danger">Terminer</Button>
        <Button colorScheme="danger">Terminer</Button>
        <Button size="lg" colorScheme="danger">Terminer</Button>
        <Button size="xl" colorScheme="danger">Terminer</Button>
        <Button colorScheme="danger">Terminer</Button>
        <Button variant="outline">Terminer</Button>
        <Button variant="plain" fullWidth>Terminer</Button>
      </div>
    </div>
  );
};
