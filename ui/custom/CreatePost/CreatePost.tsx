...
const CreatePost = () => {
    return (
        <div className='rounded-3xl bg-gray-50 border border-gray-200 mb-6'>
            <div className='px-6'>
                <input type="text" className='w-full h-20 bg-transparent' placeholder='Quoi de neuf ?' />
            </div>
            <div className='px-6'>
                <hr />
            </div>
