...
import { RiAddLine, RiImage2Fill, RiImage2Line, RiMedalFill } from 'react-icons/ri'
        ...
        <div className='mr-4 cursor-pointer'>
            ...
            <div className='rounded-full p-0.5 bg-violet-500'>
                <div className='rounded-full w-14 h-14 overflow-hidden object-containe border-2 border-white'>
                    <img src="https://images.unsplash.com/photo-1554727242-741c14fa561c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80" alt=""
